...
class TestValidateInputNode:
    ...
    @patch("process_request.core.nodes.validate_input.load_prompt", return_value="system_prompt_mock")
    @patch("process_request.core.nodes.validate_input.call_llm")
    def test_validate_input_completo_needs_more_info_false(
        ...
        from process_request.core.nodes.validate_input import validate_input
    ...
    @patch("process_request.core.nodes.validate_input.load_prompt", return_value="prompt")
    @patch("process_request.core.nodes.validate_input.call_llm")
...
class TestClassifyTypeNode:
    ...
    @patch("process_request.core.nodes.classify_type.load_prompt", return_value="system_prompt_mock")
    @patch("process_request.core.nodes.classify_type.call_llm")
    def test_classify_type_retorna_campos_corretos(
        self, mock_call_llm, mock_load_prompt, base_state
    ):
        """O update deve conter category, service_type, support_level, etc."""
        from process_request.core.nodes.classify_type import classify_type
    ...
    @patch("process_request.core.nodes.classify_type.load_prompt", return_value="prompt")
    @patch("process_request.core.nodes.classify_type.call_llm")
...
class TestScorePriorityNode:
    ...
    @patch("process_request.core.nodes.score_priority.load_prompt", return_value="prompt")
    @patch("process_request.core.nodes.score_priority.call_llm")
    def test_score_priority_caminho_feliz(
        self, mock_call_llm, mock_load_prompt, base_state
    ):
        """Fluxo normal: urgência e impacto retornados, prioridade calculada."""
        from process_request.core.nodes.score_priority import score_priority
    ...
    def test_score_priority_failsafe_quando_urgency_falha(
        ...
        from process_request.core.nodes.score_priority import score_priority, FAILSAFE_PRIORITY, DEFAULT_SCORE
    ...
    def test_score_priority_failsafe_quando_impact_falha(
        ...
        from process_request.core.nodes.score_priority import score_priority, FAILSAFE_PRIORITY
...
class TestDraftResponseNode:
    ...
    @patch("process_request.core.nodes.draft_response.load_prompt", return_value="prompt")
    @patch("process_request.core.nodes.draft_response.build_few_shot", return_value="few_shot_examples")
    @patch("process_request.core.nodes.draft_response.call_llm")
    def test_draft_response_retorna_response_draft(
        ...
        from process_request.core.nodes.draft_response import draft_response
    ...
    @patch("process_request.core.nodes.draft_response.load_prompt", return_value="prompt")
    @patch("process_request.core.nodes.draft_response.build_few_shot", return_value="")
    @patch("process_request.core.nodes.draft_response.call_llm")
    ...
    @patch("process_request.core.nodes.draft_response.load_prompt", return_value="prompt")
    @patch("process_request.core.nodes.draft_response.build_few_shot", return_value="exemplos")
    @patch("process_request.core.nodes.draft_response.call_llm")
...
class TestDraftRequestNode:
    ...
    @patch("process_request.core.nodes.draft_request.load_prompt", return_value="prompt")
    @patch("process_request.core.nodes.draft_request.call_llm")
    def test_draft_request_retorna_response_draft(
        self, mock_call_llm, mock_load_prompt, base_state
    ):
        """O nó deve retornar 'response' com 'response_draft' preenchido."""
        from process_request.core.nodes.draft_request import draft_request
...
class TestQueueOnlyNode:
    ...
    @patch("process_request.core.nodes.queue_only.open", new_callable=mock_open, read_data="[]")
    @patch("process_request.core.nodes.queue_only.json.dump")
    @patch("process_request.core.nodes.queue_only.json.load", return_value=[])
    ...
    @patch("process_request.core.nodes.queue_only.open", new_callable=mock_open)
    @patch("process_request.core.nodes.queue_only.json.dump")
    ...
    @patch("process_request.core.nodes.queue_only.open", new_callable=mock_open, read_data="[]")
    @patch("process_request.core.nodes.queue_only.json.load", return_value=[{"ticket_id": "ANTIGO"}])
    @patch("process_request.core.nodes.queue_only.json.dump")
